...
import (
	...
	"go-zero-boilerplate/app/post-service/internal/config"
	"go-zero-boilerplate/app/post-service/internal/svc"
	postservice "go-zero-boilerplate/app/post-service/internal/server/postservice"
...
var configFile = flag.String("f", "etc/postService.yaml", "the config file")
...
func main() {
	...
	s := zrpc.MustNewServer(c.RpcServerConf, func(grpcServer *grpc.Server) {
		pb.RegisterPostServiceServer(grpcServer, postservice.NewPostServiceServer(ctx))
